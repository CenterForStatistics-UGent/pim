...
#' Tudy of a pim object
#'
#' @param x An `pim` object created by [pim::pim()].
...
#' @param expit Logical indicating whether or not to apply [plogis] to the
