...
Master: [![CRAN_Status_Badge](http://www.r-pkg.org/badges/version/pim)](http://cran.r-project.org/package=pim)
...
[![Build_Status](https://travis-ci.org/CenterForStatistics-UGent/pim.svg?branch=dev2.1)](https://travis-ci.org/CenterForStatistics-UGent/pim)
...
623-671. [doi: 10.1111/j.1467-9868.2011.01020.x  ](http://dx.doi.org/10.1111/j.1467-9868.2011.01020.x)
